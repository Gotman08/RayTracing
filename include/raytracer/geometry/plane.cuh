...
/** @file plane.cuh
 *  @brief Plan infini : intersection analytique + UV */
...
/** @brief Plan infini : point + normale + materiau */
...
public:
    ...
    /** @brief Ctor : init plan + AABB geante approx. */
    ...
    /** @brief Test intersection rayon-plan + calcul UV tile */

 ...
 * @brief Rendu CPU parallelise OpenMP (meme algo que le GPU) */
...
/** @brief Variante CPU de ray_color - rebonds iteratifs avec CPURandom */
...
/** @brief Lance le rendu OpenMP - sampling + tone mapping + gamma par ligne */
